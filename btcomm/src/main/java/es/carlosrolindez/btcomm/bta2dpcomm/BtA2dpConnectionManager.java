        ...
        public void onReceive(Context ctx, Intent intent) {
            ...
            switch (action) {
                ...
                case BluetoothA2dp.ACTION_PLAYING_STATE_CHANGED: {
                    Log.e(TAG,"A2dp Play state changed");
